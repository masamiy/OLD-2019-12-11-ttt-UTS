...
venue: "ESR Wellington"        # brief name of host site without address (e.g., "Euphoric State University")
address: "34 Kenepuru Dr, Porirua 5022"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "-41.14768,174.83896"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use http://www.latlong.net/)
...
contact: ["arindam.basu@canterbury.ac.nz", "m.yamaguchi@griffith.edu.au"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
etherpad: https://pad.carpentries.org/2019-05-13-wellington            # optional: URL for the workshop Etherpad if there is one
